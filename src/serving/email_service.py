...
def send_fraud_email(
    ...
    <table cellpadding="6" cellspacing="0" style="border-collapse:collapse;">
      ...
      <tr><td><b>Time</b></td><td>Hour {features.get('hour')}</td></tr>
    ...
    <html>
      <body style="font-family:Arial, sans-serif; color:#333;">
        ...
        <p>
          <b>Risk score:</b> {fraud_probability:.6f}
        </p>
        ...
        <h3>Need help?</h3>
        <p>
          If you believe this transaction is unauthorized, please contact our
          support team.
        </p>
        <ul>
    ...
    if shap_image:
        ...
        <img src="cid:shap_chart" style="max-width:600px;"/>
        """

    html += f"""
        <h4 style="margin-top:20px;">Technical Factors (for analysts)</h4>
        <ul>
          {technical_html}
        </ul>
        ...
        <small style="color:#666;">
          ...
          You are receiving this alert because this email is registered with your account.<br/>
